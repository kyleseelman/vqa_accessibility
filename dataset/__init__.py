...
from dataset.vizwiz_dataset import vizwiz_dataset
...
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = vizwiz_dataset(config['train_file'], train_transform, config['vqa_root'], split='train') 
        vqa_test_dataset = vizwiz_dataset(config['test_file'], test_transform, config['vqa_root'], split='test', answer_list=config['answer_list'])       
        return train_dataset, vqa_test_dataset
